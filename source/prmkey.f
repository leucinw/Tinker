...
c
      ...
      else if (keyword(1:15) .eq. 'POLAR-13-INTER ') then
         read (string,*,err=10,end=10)  p13scale
         if (p13scale .gt. 1.0d0)  p13scale = 1.0d0 / p13scale
      else if (keyword(1:15) .eq. 'POLAR-14-INTER ') then
         read (string,*,err=10,end=10)  p14scale
         if (p14scale .gt. 1.0d0)  p14scale = 1.0d0 / p14scale
         ...
         read (string,*,err=10,end=10)  p31scale
         if (p31scale .gt. 1.0d0)  p31scale = 1.0d0 / p31scale
