...
c
         do j = 1, np11(i)
            ctscale(ip11(j,i)) = ct1scale
         end do
         do j = 1, np12(i)
            ctscale(ip12(j,i)) = ct2scale
         end do
         do j = 1, np13(i)
            ctscale(ip13(j,i)) = ct3scale
         end do
         do j = 1, np14(i)
            ctscale(ip14(j,i)) = ct4scale
         end do
c
...
c
         do j = 1, np11(i)
            ctscale(ip11(j,i)) = 1.0d0
         end do
         do j = 1, np12(i)
            ctscale(ip12(j,i)) = 1.0d0
         end do
         do j = 1, np13(i)
            ctscale(ip13(j,i)) = 1.0d0
         end do
         do j = 1, np14(i)
            ctscale(ip14(j,i)) = 1.0d0
         end do
      end do
c
...
!$OMP& i12,i13,i14,i15,ct1scale,ct2scale,ct3scale,ct4scale,
