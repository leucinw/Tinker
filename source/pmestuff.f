...
c
c
      subroutine fphi_uind (fdip_phi1,fdip_sum_phi)
      use sizes
      use mpole
      use pme
      implicit none
...
!$OMP& thetai1,qgrid,fdip_phi1,fdip_sum_phi)
!$OMP DO
c
...
c
         ...
         fdip_sum_phi(4,isite) = 2.0d0*tuv001
         fdip_sum_phi(5,isite) = 2.0d0*tuv200
         fdip_sum_phi(6,isite) = 2.0d0*tuv020
         fdip_sum_phi(7,isite) = 2.0d0*tuv002
         fdip_sum_phi(8,isite) = 2.0d0*tuv110
         fdip_sum_phi(9,isite) = 2.0d0*tuv101
         fdip_sum_phi(10,isite) = 2.0d0*tuv011
         fdip_sum_phi(11,isite) = 2.0d0*tuv300
         fdip_sum_phi(12,isite) = 2.0d0*tuv030
         fdip_sum_phi(13,isite) = 2.0d0*tuv003
         fdip_sum_phi(14,isite) = 2.0d0*tuv210
         fdip_sum_phi(15,isite) = 2.0d0*tuv201
         fdip_sum_phi(16,isite) = 2.0d0*tuv120
         fdip_sum_phi(17,isite) = 2.0d0*tuv021
         fdip_sum_phi(18,isite) = 2.0d0*tuv102
         fdip_sum_phi(19,isite) = 2.0d0*tuv012
         fdip_sum_phi(20,isite) = 2.0d0*tuv111
      end do
c
c     OpenMP directives for the major loop structure
c
